...
public class JsonServiceClient {
    ...
    public <T> T put(final String path, final Map<String, Object> params, final Class<T> returnClazz)
            throws OpenpayServiceException, ServiceUnavailableException {
        URI uri = this.buildUri(path);
        HttpPut request = new HttpPut(uri);
        request.setEntity(new StringEntity(this.serialize(params), ContentType.APPLICATION_JSON));
